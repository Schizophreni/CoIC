...
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ | --------- | --------- | -------------------------------- | ---------------------------- | ---------------------------------- |
| Baseline | [model](checkpoints/Baseline/brn_model.pth)                  | [model](checkpoints/Baseline/rcdnet_model.pth)               | [model]() | [model]() | [model]()                        | [model]()                    | [model]()                          |
| w/ CoIC  | [model](checkpoints/CoIC/brn_model.pth) [encoder](checkpoints/CoIC/brn_enc.pth) | [model](checkpoints/CoIC/rcdnet_model.pth) [encoder](checkpoints/CoIC/rcdnet_enc.pth) | [model]() | [model]() | [model]()                        | [model]()                    | [model]()                          |
